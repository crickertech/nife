...
//! honest-absence shape [`env()`] already has for the general case. See `environment_protocol` for why this
...
pub fn seed() {
    ...
    // (the page has exactly one writer, and it is not this process; see `environment_protocol`'s docs).
