...
//!   `components/src/timetable.rs`'s module docs, which name the four consumers already waiting on
...
/// (`components/src/timetable.rs`'s module docs name the gap and its other consumers); this is the same
