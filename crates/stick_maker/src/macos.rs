...
//! the plist and not the table). [`assemble`] is the pure half, tested against documents captured
//! from a real machine; [`discover`], [`erase`] and [`eject`] are the half that runs the tool.
//!
//! # BUGS
//!
