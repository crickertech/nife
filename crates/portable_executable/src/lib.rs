...
//! which puts it on the spelled-out side of §154's test; an architect's call either way).
//! Considered and set aside `elf_to_efi` (a verb phrase, and systemd's tool name) and `pe_image`
//! (the acronym).
//!
