...
//! applies to a proposal. The same split `filesystem_protocol` makes for the filesystem and `graphics_protocol` for
//! the framebuffer.
//!
...
//!
//! ```
//! use clock_protocol::{NANOS_PER_SEC, offset_for, wall_nanos};
//!
