...
/// in `.bss` rather than on the stack. `components/src/mdr.rs` shows the shape.
pub struct Renderer {
    style: Style,
...
/// `snake_case` identifiers in running prose constantly (`filesystem_protocol`, `line_editor`,
