...
//! share one window** (milestone 599, the remaining piece). The server now keeps a window per
...
//! 24-slot table (DECISIONS §102), so it must address windows some other way. Until that lands,
