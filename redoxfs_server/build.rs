...
//! script `components`, `fixtures` and `std_exerciser` use, `crates/user_rt/link.ld` (linked at
...
fn main() {
    ...
    println!("cargo::rustc-link-arg-bin=redoxfs_server=-T{dir}/../crates/user_rt/link.ld");
