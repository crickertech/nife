...
//! writes [`capability_demo_proto::PAGE_FRAME_SENTINEL`], and hands the consumer a READ-only view
...
use user_rt::{exit, map_page_frame, retype_page_frame, send_cap};
...
pub extern "C" fn _start(_arg0: u64, _arg1: u64, _arg2: u64) -> ! {
    ...
    unsafe {
        core::ptr::write_volatile(
            ...
            capability_demo_proto::PAGE_FRAME_SENTINEL,
        );
    }
