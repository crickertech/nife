...
//! # What it proves
//!
//! It paints [`graphics_protocol::pixel`], a per-coordinate function rather than a fill, then flushes, then
...
pub extern "C" fn _start(_arg0: u64, _arg1: u64, _arg2: u64) -> ! {
    ...
    // the digest below (crates/graphics_protocol asserts exactly those properties on the host).
    for y in 0..h {
        for x in 0..w {
