...
//! [`PEOPLE`], which lives in `credential_proto::fixture` now because three files were keeping their
//! own copy of it.
//!
...
//! The serve loop it reaches implements one opcode. See components/src/credentialer.rs.
//!
