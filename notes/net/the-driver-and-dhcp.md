...
main page. A reader who only needs to use the socket contract should not have to open it. Moved
...
hands a driver either way). It owns the registers and the two DMA-critical powers, and hands the driver
