...
lags its job** as a result, and a rename is an architect's call. Where this file says "the credential
...
Proofs (`script/verify`, three Kani harnesses over `credential_protocol`, 30 checks, 0.2 s). Both properties
