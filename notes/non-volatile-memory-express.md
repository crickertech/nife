...
**"Confined" means the IOMMU unit that owns the controller is the one translating**, since
2026-09-24. It used to mean that some unit was up, which on a machine with two VT-d units (a client
