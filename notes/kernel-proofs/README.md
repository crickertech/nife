# Appendices to notes/kernel-proofs.md

[`notes/kernel-proofs.md`](../kernel-proofs.md) is the page to read. Each file here holds detail it
links to, moved out under §212 (a prose budget) so the main page stays inside
its word budget.
