...
- [Address-space map](address-space-map.md): what each band holds.
...
- [The RISC-V TLB shootdown](riscv-tlb-shootdown.md): cross-hart ASID flush via SBI RFENCE.
- [The x86_64 TLB shootdown](x86-tlb-shootdown.md): cross-core TLB invalidation by NMI.
