# Scheduled execution: the appendices

[`notes/scheduled-execution.md`](../scheduled-execution.md) is the page to read. The files here hold
work that page points at but does not need to carry whole.
