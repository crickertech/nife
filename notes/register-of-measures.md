...
| unsafe density outside `kernel/src/arch/` | `script/lint` | over 96 blocks per 10,000 lines of code |
...
maximum. 17 is today's tree exactly. And 96 per 10,000 (lowered from 100, then 97, by milestone 139) is a
**claim about the tree that was false until shortly before it was written**, which makes it the
