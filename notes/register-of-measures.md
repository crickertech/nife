...
| unsafe density outside `kernel/src/arch/` | `script/lint` | over 97 blocks per 10,000 lines of code |
...
maximum. 17 is today's tree exactly. And 97 per 10,000 (lowered from 100 by milestone 139) is a
