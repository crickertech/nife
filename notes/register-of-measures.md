...
maximum. 17 is today's tree exactly. And PLACEHOLDER_CEILING per 10,000 (lowered from 100, then 97,
then 96, then 95, then 94, then PLACEHOLDER_CEILING, by milestone 139) is a **claim about the tree
that was false until shortly before it was written**, which makes it the
