...
fn shell_check_leg_graphical(riscv: bool, keystrokes: Keystrokes) -> bool {
    ...
    // `helpers/qemu-runner-*.sh` exactly the way they always have been (milestone 177 (wire the graphical terminal stack into the real
    // interactive boot) changed what
