...
use filesystem_protocol::fixture::{rm as rr, tree};
...
struct Outcome {
    /// Its exit status: 0, or the errno of the first failure (`filesystem_protocol::fixture::rm`).
    status: u64,
