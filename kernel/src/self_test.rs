...
//!
//! The wording is **provisional** (milestone 268): a line two programs agree on is an architect's
//! under AGENTS.md's *move fast on what can be undone* tenet, and the milestone block says a lane
//! should ship one and say so rather than wait. The other half of the contract is
