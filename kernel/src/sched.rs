...
struct IpcTables {
    ...
    rendezvous_table: slots::Table<u64, MAX_RENDEZVOUS>,
...
/// down a region removes every rendezvous whose page lives in it and `slots::Table::remove` frees the
...
pub fn init() {
    ...
    *sched = Some(IpcTables {
        threads,
        rendezvous_table: slots::Table::new(),
