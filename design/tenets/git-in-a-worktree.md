...
never squash across purposes. This file carries why each rule exists and the failure that produced it,
all of them from days when a lane lost work or took another lane's. Moved here 2026-09-23 (UTC) on
