...
the maintainer from calef's ruling in DECISIONS §159: *"Live-patching a kernel is a separate
...
§159 makes every userspace upgrade reboot-free and accepts one reboot for a new kernel.
