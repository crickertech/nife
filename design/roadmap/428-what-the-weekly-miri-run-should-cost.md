...
cadence itself is an architect's call; the measurement and the cut are not. *(Number provisional until the
...
crates in this tree already follow, and neither needs a ruling. Only the last step is an architect's,
