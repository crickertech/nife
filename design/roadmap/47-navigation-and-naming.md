...
lane's time pressure," and what the second directory should even *be* is an architect's boot-time policy
...
**Three encodings, with what each costs.** They are not equivalent and the choice is an architect's, because
