...
answer. It is an architect's call whether the declaration widens, and it should not widen on a lane's
...
Whether the declaration widens is an architect's, which is why the gate is DECISION: three shapes are
