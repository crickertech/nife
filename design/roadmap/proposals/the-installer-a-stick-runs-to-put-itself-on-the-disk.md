# The installer: a stick that puts itself on the machine's disk and is then not needed

**Status: PROPOSED 2026-09-19.** Written by milestone 198's rungs lane
(`milestone/198-rungs-to-a-trivial-install`) for rung 2 of the trivial install DECISIONS §157
defines. §157's table names the installer as owned by no milestone; this is the proposal for it.
