...
evidence it was fixed was a **scaffold**: milestone 233's lane patched `fixtures/src/worker.rs` to trap,
...
was a patch to `fixtures/src/worker.rs` and was removed afterwards, so nothing stops the lost prompt
returning."*
