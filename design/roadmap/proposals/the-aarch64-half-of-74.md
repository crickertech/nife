# The aarch64 half of milestone 74: two decisions left, now that the counter runs
...
### 1. What else was considered, and why each is a live option rather than a loser
...
### 5. What each costs, measured rather than asserted
...
### 7. Would the choice be the same if every option cost the same?
