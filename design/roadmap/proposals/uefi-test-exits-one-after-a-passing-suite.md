# `uefi-test` can exit 1 after its own suite has passed, and nobody has taken a rate

**Status: PROPOSED 2026-09-19.** Written by milestone 117's run 6 lane, from the stranger's red
