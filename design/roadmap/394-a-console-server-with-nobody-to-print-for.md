...
[§177](../decisions/177-console-server-with-no-client.md) *(number provisional)*, written up
...
§177 is what its replacement should cite if anything survives it.
...
out loud. It is calef's because it is not the narrator, and because the second option touches the
