...
- **The fourth shape is a syscall-surface addition** whatever its size, so it is an architect's under §10
...
**Whether that consumer should be served is an architect's**, under §101's carve-out and milestone 106's
