...
**Status: PARTIAL.** Built 2026-09-19 on `milestone/shell-on-the-firmware-screen` (pull request
#980): under OVMF the shell's prompt is on the screen, a command typed on the serial line answers
