...
[§188](../decisions/188-what-a-baseline-save-must-record.md) *(number provisional)*, written up
...
**There is a live argument that the token is still too strong, and §188 puts it to calef as its
