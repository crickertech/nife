...
[§187](../decisions/187-what-a-baseline-save-must-record.md) *(number provisional)*, written up
...
**There is a live argument that the token is still too strong, and §187 puts it to calef as its
