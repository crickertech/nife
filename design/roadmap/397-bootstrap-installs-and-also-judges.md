...
which is exactly the reader the check was written for. It is an architect's because the exit code of
a canonical "Scripts to Rule Them All" entry point is read by four callers.
