...
|---|---|---|---|
| ~~**Format**~~ | **Decided 2026-09-20 (DECISIONS §197): one archive file per package**, identified by name and version, with §195's reviewed recipe carrying its digest. Where the manifest travels and whether the digest is a Merkle root are still calef's, narrowed by the ruling. | 3a | [DECISIONS §197](../decisions/197-a-package-is-one-archive-file.md) |
