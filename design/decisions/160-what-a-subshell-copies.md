...
Raised 2026-09-19 by milestone 435 (forty-five milestones are gated on a decision nobody wrote down)'s lane, which found that milestone 52 (subshells without `fork`, and what copying an endowment means) has
