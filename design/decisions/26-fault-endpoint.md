...
`/chosen/linux,initrd-start` got to be init. Milestone 16b (IOMMU-backed driver isolation), whose boundary proof is §20 (IOMMU-backed DMA isolation: one seam, two arch drivers), had already closed the DMA
